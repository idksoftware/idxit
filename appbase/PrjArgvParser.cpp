...
namespace CommandLineProcessing {
	...
	ReturnCode PrjArgvParser::parseErrorNumber(ParserResults _error_code) const
	{
	...
	bool PrjArgvParser::handleParseResult(int argc, char** argv) {
	...
	bool PrjArgvParser::addSubCommand(std::shared_ptr<SubCommand > subCommand) {
		m_list.push_back(subCommand);
		return true;
	}

	bool PrjArgvParser::doCommand() {
